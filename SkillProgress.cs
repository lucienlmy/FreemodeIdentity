...
namespace FreemodeIdentity {
	...
	internal sealed class SkillProgress {
		...
		const float BaseXpPerLevel = 300f; // XP for one level at 1x speed
		public const float DefaultSpeed = 1.0f;
		public const float MinSpeed = 0.1f, MaxSpeed = 40f; // clamp a hand-edited value sane (40x = the top preset)
