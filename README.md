...
levels are a grind. A **Progression Speed** setting (0.25x to 40x) scales the whole climb. The
...
- **Skills ▸**
  ...
  - One **0-100 setter per skill** (stamina, shooting, strength, stealth, flying, driving,
    ...
    spoofed.
  - **Progression Speed** - how fast progressing skills climb (0.25x to 40x); halted skills
    are unaffected.
- **Spoofing ▸**
